...
#         cat_model = CatBoostRegressor(n_estimators=1500, learning_rate=0.1, depth=9, loss_function='LogCosh', silent=True, min_data_in_leaf=child, l2_leaf_reg=L2)
#         cat_model.fit(X_train,y_train)
...
cat_model = CatBoostRegressor(n_estimators=1500, learning_rate=0.1, depth=9, loss_function='LogCosh', silent=True, min_data_in_leaf=0, l2_leaf_reg=0.2)
cat_model.fit(X_train,y_train)
