...
# for est in np.arange(100, 1700, 200):
#     for rat in np.arange(0.06, 0.24, 0.02):
#         for dep in np.arange(3, 10, 1):
            
#             print(est, rat, dep)
        
#             light_model = LGBMRegressor(n_estimators=est, learning_rate=rat, max_depth=dep, boosting_type='gbdt', num_leaves=(2**5), verbosity=-1, min_data_in_leaf=0, lambda_l2=0)    
...
#             results.append([est, rat, dep, mse_train, mse, results_light.mean(), results_light.std()*100.0])
...
# for child in np.arange(0, 36, 5):
#     for L2 in np.arange(0, 2.0, 0.2):
        
#         print(child, L2)
        
#         light_model = LGBMRegressor(n_estimators=1500, learning_rate=0.14, max_depth=9, boosting_type='gbdt', num_leaves=(2**5), verbosity=-1, min_data_in_leaf=child, lambda_l2=L2)    
#         light_model.fit(X_train,y_train)
...
#         results.append([child, L2, mse_train, mse, results_light.mean(), results_light.std()*100.0])
...
light_model = LGBMRegressor(n_estimators=1500, learning_rate=0.14, max_depth=9, boosting_type='gbdt', num_leaves=(2**5), verbosity=-1, min_data_in_leaf=0, lambda_l2=0)    
light_model.fit(X_train,y_train)
