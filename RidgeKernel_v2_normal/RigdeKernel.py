...
# name = 'results_ridge_total_par_2.pkl'
# results.to_pickle(name)
# best_tunning = pd.read_pickle(name)

# # # chi2_kernel
RidgeKernel_model = KernelRidge(alpha=0.005, kernel='laplacian', gamma=None)
RidgeKernel_model.fit(X_train,y_train)
...
outfile.write("MSE Train Set XGB Regression: " + str(round(mse_train,4)) + "\n")
outfile.write("RMSE Train Set XGB Regression: " + str(round(np.sqrt(mse_train),4)) + "\n")
outfile.write("MAE Train Set XGB Regression: " + str(round(mae_train,4)) + "\n")
outfile.write("MSE Test Set XGB Regression: " + str(round(mse,4)) + "\n")
outfile.write("RMSE Test Set XGB Regression: " + str(round(np.sqrt(mse),4)) + "\n")
outfile.write("MAE Test Set XGB Regression: " + str(round(mae,4)) + "\n")
...
plt.tight_layout()
plt.savefig('Predict_vs_Real.png', dpi=200, transparent=True)
plt.show()
